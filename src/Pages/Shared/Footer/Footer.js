        ...
        <div className=' bg-black text-white'>
            <div className='w-11/12 mx-auto'>
                <footer className="footer py-10">
                    <div>
                    <Link to='/' className="flex items-center uppercase text-4xl font-bold text-primary"><span>C</span><FaCar className='inline-block' /><span>R</span>&nbsp;<span>BAZAR</span></Link>
                        <p>CarBazar.com<br />Providing reliable second hand cars.</p>
                    </div>
                    <div>
                ...
                <hr />
                <div className="footer items-center py-4">
                    <div className="items-center grid-flow-col">
                        <p>©2022 CarBazar - All right reserved.</p>
                    </div>
